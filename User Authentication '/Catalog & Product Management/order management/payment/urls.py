...
class CreateCheckoutSessionView(APIView):
    ...
    def post(self, request):
        ...
        is_stripe_configured = bool(
            ...
            not stripe.api_key.startswith('mock')
        )
        try:
            ...
            return Response({
                ...
                "mock_mode": not is_stripe_configured,
...
class CreatePaymentIntentView(APIView):
    ...
    def post(self, request):
        ...
        is_stripe_configured = bool(stripe.api_key and not stripe.api_key.startswith('your_stripe'))
        try:
            if is_stripe_configured:
...
class PaymentVerificationView(APIView):
    ...
    def post(self, request):
        ...
        payment = get_object_or_404(Payment, stripe_payment_intent_id=session_id)
        order = payment.order
